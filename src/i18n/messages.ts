...
• Wholesale supply`,
    ...
    reviews: {
        ...
        moreHint: "+100 positive reviews — we can share more on request.",
        items: {
            ...
            "5": "The goods were delivered very well; from now on I will work only with you. Top level!",
            "6": "Delivered on time, prices much better than other cargo companies, they answered every question fast. Best part — pickup from the office.",
            "7": "You are the best at what you do.",
            "8": "While others find excuses not to work, Assayf keeps running smoothly.",
            "9": "I transferred money through your company. I was surprised how fast you replied and how quickly and professionally you completed the transfer.",
            "10": "From now on I will only send or receive money through you.",
            "11": "For years I had a strong appetite problem; after taking Assayf Mass my appetite clearly improved. I eat 3–4 times a day with real appetite. Sleep and energy normalized.",
            "12": "It’s been 3–4 days since I started the Assayf Mass mix and my sleep schedule settled — I rest very well now.",
            "13": "I started Assayf Mass: sleep got deeper, I have more energy and better focus. Appetite went up and weight is steadily gaining. Most importantly — the product is natural!",
        },
    },
    contact: {
...
• Оптовые поставки`,
    ...
    reviews: {
        ...
        moreHint: "+100 положительных отзывов — по запросу пришлём ещё.",
        items: {
            ...
            "5": "Товар очень хорошо доставили, в дальнейшем буду работать только с вами. Высокий уровень!",
            "6": "Товар доставили своевременно, цены намного лучше, чем у других карго, отвечали на любой вопрос быстро. Самое лучшее — самовывоз товара из офиса.",
            "7": "Вы лучшие в своём деле.",
            "8": "Пока другие находят причины, чтобы не работать, Assayf в штатном режиме работает без сбоев.",
            "9": "Через вашу компанию перевёл деньги. Был удивлён тому, как быстро вы отвечали и как быстро и профессионально вы сделали перевод.",
            "10": "Впредь обязуюсь отправлять или принимать деньги только через вас.",
            "11": "В последние годы была сильная проблема с аппетитом, после приёма продукта Assayf Mass аппетит явно улучшился. Кушаю в день 3–4 раза с аппетитом. Режим сна и энергия нормализовались.",
            "12": "Прошло 3–4 дня, как я начал кушать смесь Assayf Mass, и у меня наладился режим сна, стал высыпаться очень хорошо.",
            "13": "Начал принимать Assayf Mass — сон стал крепче, появилась энергия и улучшилась концентрация. Аппетит заметно вырос, а вес начал стабильно прибавляться. Самое важное — продукт натуральный!",
        },
    },
    contact: {
...
• Toptan tedarik`,
    ...
    reviews: {
        ...
        moreHint: "+100 olumlu yorum — isterseniz daha fazlasını paylaşabiliriz.",
        items: {
            ...
            "5": "Mal çok iyi teslim edildi; bundan sonra yalnızca sizinle çalışacağım. Çok yüksek seviye!",
            "6": "Zamanında teslimat, fiyatlar diğer kargolara göre çok daha iyi, her soruya hızlı yanıt. En iyisi — ofisten teslim alma.",
            "7": "İşinizde en iyisisiniz.",
            "8": "Başkaları çalışmamak için bahane üretirken Assayf sorunsuz şekilde işini sürdürüyor.",
            "9": "Parayı şirketiniz üzerinden gönderdim. Ne kadar hızlı döndüğünüz ve transferi ne kadar hızlı ve profesyonelce tamamladığınıza şaşırdım.",
            "10": "Bundan sonra parayı yalnızca sizin aracılığınızla gönderecek veya alacağıma söz veriyorum.",
            "11": "Son yıllarda iştahım ciddi sorundu; Assayf Mass kullanmaya başladıktan sonra iştahım bariz şekilde düzeldi. Günde 3–4 kez iştahlı yemek yiyorum. Uyku ve enerji normale döndü.",
            "12": "Assayf Mass karışımına başlayalı 3–4 gün oldu; uyku düzenim oturdu, çok iyi uyuyorum.",
            "13": "Assayf Mass'a başladım: uyku derinleşti, enerji ve odak arttı. İştah belirgin şekilde yükseldi, kilo istikrarlı şekilde artıyor. En önemlisi — ürün doğal!",
        },
    },
    contact: {
